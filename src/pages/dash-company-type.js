...
// import pic1 from "../assets/images/images/companyType-company/pic1.jpg"
// import pic2 from "../assets/images/images/companyType-company/pic2.jpg"
// import pic3 from "../assets/images/images/companyType-company/pic3.jpg"
// import pic4 from "../assets/images/images/companyType-company/pic4.jpg"
// import pic5 from "../assets/images/images/companyType-company/pic5.jpg"
...
export default function Company_Type() {
    const token = localStorage.getItem("token");
    const navigate = useNavigate()
    const [companyType, setCompanyType] = useState()
    useEffect(()=>{
        const apiUrl = "https://sartor-server-beta.onrender.com/api/v1/sales-agent/company/type/all"
    ...
    const deleteData = (id) => {
        ...
        .then((res)=> {
            console.log(res)
            setCompanyType((prevSales) => prevSales.filter(item => item.id !== id));
      ...
      const editCompany = (id) => {
            navigate(`/dash-edit-company-type/${id}`)
      }
                ...
                <div id="content">
                    ...
                    <div className="content-admin-main">
                        ...
                        <div className="wt-admin-right-page-header clearfix">
                            <h2>Manage Company Type</h2> 
                            <div className="breadcrumbs"><a href="#">Home</a><a href="#">Dasboard</a><span>Company Type</span></div>
                        </div>
                        ...
                        <div className="panel panel-default">
                            <div className="panel-heading wt-panel-heading p-a20">
                                <div className="row">
                                    <div className="col"><h4 className="panel-tittle m-a0"><i className="fa fa-suitcase"></i> Company Type</h4></div>
                                    <div className="col-auto"><Link to="/dash-post-company-type" className="btn btn-primary">Post Company Type</Link></div>
                                </div>
                            </div>
                                ...
                                <div className="twm-D_table p-a20 table-responsive">
                                    <table id="companyType_bookmark_table" className="table table-bordered twm-bookmark-list-wrap">
                                        ...
                                        <tbody>
                                            {/* <!--1--> */}
                                            {
                                                companyType && companyType.map((comp)=>(
                                                    <tr>
