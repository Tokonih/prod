...
const [loading, setLoading] = useState(false)
  const createCompany = async (e) => {
    ...
    companyFormData.append('image', imageURL);
    companyFormData.append('managerEmail', managerEmail);
    companyFormData.append('managerName', managerName);
    companyFormData.append('managerPhone', managerPhone);
    companyFormData.append('phone', phone);
    companyFormData.append('typeOfCompanyID', selectedCompanyId);
    
    console.log(companyFormData);

    let apiURL = BASEURL + "/sales-agent/company" 
    let adminToken = localStorage.getItem("sator-agent-token");
    ...
    axios.post(apiURL, companyFormData, {headers})
    .then((res)=> {
