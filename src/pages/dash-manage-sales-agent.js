...
export default function DashSalesAgent() {
    ...
    useEffect(()=>{
        const apiUrl = "https://sartor-server-beta.onrender.com/api/v1//sales-agent/all"
    ...
    const apiUrl = `https://sartor-server-beta.onrender.com/api/v1/sales-agent/delete`
                ...
                <div id="content">
                    ...
                    <div className="content-admin-main">
                        ...
                        <div className="wt-admin-right-page-header clearfix">
                            ...
                            <div className="breadcrumbs"><a href="#">Home</a><a href="#">Dasboard</a><span>Agent Listing</span></div>
                        </div>
                        ...
                        <div className="panel panel-default">
                            <div className="panel-heading wt-panel-heading p-a20">
                                <div className="row">
                                    <div className="col"><h4 className="panel-tittle m-a0"><i className="fa fa-suitcase"></i> Agent Details</h4></div>
                                    <div className="col-auto"><Link to="/dash-create-sales-agent" className="btn btn-primary">Create a Agent</Link></div>
                                </div>
                            </div>
                                            ...
                                            {/* <!--1--> */}
                                            {
                                                sales && sales.map((comp)=> (
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="javascript:;" className="site-text-primary">{comp.email}</a></td>
                                                        <td>
                                                        {comp.phone}
                                                        </td>
