...
export default function DashEditDeal() {
...
useEffect(() => {
  const getCompany = async () => {
      let api_url =`https://sartor-server-beta.onrender.com/api/v1/sales-agent/deal/` + dealId;
      ...
      try {
          ...
          setdealName(res.data.data.deal.dealName)
          setId(res.data.data.deal._id)
          // setCompanies(res.data.data.company.companyID)
...
useEffect(() => {
  ...
  const editDeal = (e) => {
    ...
    let apiURL = "https://sartor-server-beta.onrender.com/api/v1/sales-agent/deal/edit" 
    let adminToken = localStorage.getItem("sator-agent-token");
    ...
    axios.put(apiURL, updateDeal, {headers})
    .then((res)=> {
        console.log(res)
        alert("Deal updated")
    }).catch((err)=>{
            ...
            <div className="panel panel-default">
              <div className="panel-heading wt-panel-heading p-a20">
                <h4 className="panel-tittle m-a0">
                  <i className="fa fa-suitcase"></i> Edit Deal
                </h4>
              </div>
                  ...
                  <div className="col-lg-12 col-md-12">
                      <div className="text-left">
                        <button type="submit" className="site-button m-r5">
                          {loading? "Update Deal " : "Update Deal "}
                        </button>
                        {/* <button
                          type="submit"
