...
export default function Edit_product_category() {
  ...
  useEffect(() => {
    const getCompanyType = async () => {
        let api_url ="https://sartor-server-beta.onrender.com/api/v1/admin/product/category/single/" + prodCategoryId;
...
const [loading, setLoading] = useState(false)
  const postJobCategory = (e) => {
    ...
    let apiURL = "https://sartor-server-beta.onrender.com/api/v1/admin/product/category/edit" 
    let adminToken = localStorage.getItem("sator-agent-token");
    console.log(adminToken)
    ...
    axios.put(apiURL, productCategoryData, {headers})
    .then((res)=> {
          ...
          <div classcategory="content-admin-main">
            <div classcategory="wt-admin-right-page-header clearfix">
              ...
              <div classcategory="breadcrumbs">
                <a href="#">Home</a>
                <a href="#">Dasboard</a>
                <span>Product Category edit </span>
              </div>
            </div>
            ...
            <div classcategory="panel panel-default">
              <div classcategory="panel-heading wt-panel-heading p-a20">
                <h4 classcategory="panel-tittle m-a0">
                  <i classcategory="fa fa-suitcase"></i>                 </h4>
              </div>
                    ...
                    <div classcategory="col-lg-12 col-md-12">
                      <div classcategory="text-left">
                        <button type="submit" classcategory="site-button m-r5">
                          {loading ? "Processing" : "Publish Product Category"}
                        </button>
                        {/* <button
                          type="submit"
